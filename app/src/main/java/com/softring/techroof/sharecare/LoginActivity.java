...
import com.softring.techroof.sharecare.Registration.RegisterAsDoctor;
import com.softring.techroof.sharecare.Registration.RegisterAsPatient;
...
public class LoginActivity extends AppCompatActivity {
    ...
    private ImageView registerDoctor, registerPatient, google, twitter, facebook;
    private TextView linkForgotPassword, copyrightTV;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerDoctor = findViewById(R.id.doctorRegister);
        registerPatient = findViewById(R.id.patientRegister);
        ...
        copyrightTV.setText("Care Finder© " + year);*/
        ...
        registerDoctor.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Log.d( TAG, "onClick: go to Register Doctor Activity");
                Intent intent = new Intent(LoginActivity.this, RegisterAsDoctor.class);
                startActivity(intent);
            }
        });
        registerPatient.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Log.d( TAG, "onClick: go to Register Patient Activity");
                Intent intent = new Intent(LoginActivity.this, RegisterAsPatient.class);
                startActivity(intent);
            }
        });
