...
public class ForgotPasswordActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Account Security");
        ...
        resetPassButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(email)){
                    ...
                    Toast.makeText(ForgotPasswordActivity.this, "Email format is not valid.", Toast.LENGTH_SHORT).show();
                } else {
                    ...
                    auth.sendPasswordResetEmail(email).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(ForgotPasswordActivity.this, "Oops!! "+ e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    });
                }
            }
        ...
        copyrightTV2.setText("Care Finder© " + year);
