...
import com.softring.techroof.sharecare.Model.Friends;
import com.softring.techroof.sharecare.Profile.ProfileActivity;
import com.squareup.picasso.Picasso;

import de.hdodenhof.circleimageview.CircleImageView;

public class ConsultantChatsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_consultant_chats);

        toolbar = findViewById(R.id.consultants_appbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("Consultant Chats");
                    ...
                    public void onDataChange(@NonNull final DataSnapshot dataSnapshot) {
                        ...
                        holder.itemView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                AlertDialog.Builder builder = new AlertDialog.Builder(ConsultantChatsActivity.this);
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        if (which == 0){
                                            ...
                                            if (dataSnapshot.child("active_now").exists()){
                                                ...
                                                Intent chatIntent = new Intent(ConsultantChatsActivity.this, ChatActivity.class);
                                                ...
                                                userDatabaseReference.child(userID).child("active_now")
                                                    ...
                                                    public void onSuccess(Void aVoid) {
                                                        Intent chatIntent = new Intent(ConsultantChatsActivity.this, ConsultantChatsActivity.class);
                                                        chatIntent.putExtra("visitUserId", userID);
                                                        chatIntent.putExtra("userName", userName);
                                                        startActivity(chatIntent);
                                                    }
                                        ...
                                        if (which == 1){
                                            Intent profileIntent = new Intent(ConsultantChatsActivity.this, ProfileActivity.class);
