package com.softring.techroof.sharecare.Profile;
...
import com.softring.techroof.sharecare.ChatActivity;
...
public class ProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Consultant Profile");
        ...
        if (!senderID.equals(receiver_userID)){ // condition for current owner / sender id
            ...
            go_my_profile.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(ProfileActivity.this, ProfileSettings.class);
    ...
    private void unfriendPersonNotify() {
        NotificationCompat.Builder builder = (NotificationCompat.Builder)
                new NotificationCompat.Builder(ProfileActivity.this, "My Channel");
        builder.setSmallIcon(R.drawable.start_logo);
        builder.setContentTitle("Care Finder Updates");
        builder.setContentText("Un-friend your friend has been successfully...");
        builder.setAutoCancel(true);
        NotificationManagerCompat notificationManagerCompat = NotificationManagerCompat.from(ProfileActivity.this);
        notificationManagerCompat.notify(5, builder.build());
    }

    private void acceptFriendNotify() {
        NotificationCompat.Builder builder = (NotificationCompat.Builder)
                new NotificationCompat.Builder(ProfileActivity.this, "My Channel");
        builder.setSmallIcon(R.drawable.start_logo);
        builder.setContentTitle("Care Finder Updates");
        builder.setContentText("Friend request has been accepted successfully...");
        builder.setAutoCancel(true);
        NotificationManagerCompat notificationManagerCompat = NotificationManagerCompat.from(ProfileActivity.this);
        notificationManagerCompat.notify(4, builder.build());
    }

    private void cancelFriendNotify() {
        NotificationCompat.Builder builder = (NotificationCompat.Builder)
                new NotificationCompat.Builder(ProfileActivity.this, "My Channel");
        builder.setSmallIcon(R.drawable.start_logo);
        builder.setContentTitle("Care Finder Updates");
        builder.setContentText("Friend request has been cancel successfully...");
        builder.setAutoCancel(true);
        NotificationManagerCompat notificationManagerCompat = NotificationManagerCompat.from(ProfileActivity.this);
        notificationManagerCompat.notify(3, builder.build());
    }

    private void sendFriendNotify() {
        NotificationCompat.Builder builder = (NotificationCompat.Builder)
                new NotificationCompat.Builder(ProfileActivity.this, "My Channel");
        builder.setSmallIcon(R.drawable.start_logo);
        builder.setContentTitle("Care Finder Updates");
        builder.setContentText("Friend Request has been sent successfully...");
        builder.setAutoCancel(true);
        NotificationManagerCompat notificationManagerCompat = NotificationManagerCompat.from(ProfileActivity.this);
