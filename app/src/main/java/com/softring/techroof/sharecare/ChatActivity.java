...
import com.softring.techroof.sharecare.Adapters.MessageAdapter;
import com.softring.techroof.sharecare.Model.Message;
import com.softring.techroof.sharecare.Utils.UserLastSeenTime;
...
//                        }
    ...
    private void AcceptedPostNotification() {
        NotificationCompat.Builder builder = (NotificationCompat.Builder)
                new NotificationCompat.Builder(ChatActivity.this, "My Channel");
                        builder.setSmallIcon(R.drawable.start_logo);
                        builder.setContentTitle("Care Finder Updates");
                        builder.setContentText("Your message has been sent successfully...");
