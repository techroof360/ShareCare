...
import com.softring.techroof.sharecare.MainActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        saveInfoBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent mainIntent = new Intent(ProfileSettings.this, MainActivity.class);
        ...
        editStatusBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent statusUpdateIntent = new Intent(ProfileSettings.this, ProfileStatusUpdate.class);
                    ...
                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            ...
                            new Timer().schedule(new TimerTask(){
                                public void run() {
                                    ProfileSettings.this.runOnUiThread(new Runnable() {
                                        public void run() {
                ...
                Task<Uri> uriTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                    ...
                    public Task<Uri> then(@NonNull Task<UploadTask.TaskSnapshot> task){
                        if (!task.isSuccessful()){
                            Toast.makeText(ProfileSettings.this, "Profile Photo Error: " + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                    ...
                    public void onComplete(@NonNull Task<Uri> task) {
                        if (task.isSuccessful()){
                            ...
                            Task<Uri> thumbUriTask = thumb_uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                                ...
                                public Task<Uri> then(@NonNull Task<UploadTask.TaskSnapshot> task){
                                    if (!task.isSuccessful()){
                                        Toast.makeText(ProfileSettings.this, "Thumb Image Error: "  + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                                    }
